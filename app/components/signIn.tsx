...
export default function SignIn({
  ...
  return (
    <>
      ...
      <p>
        Setup your account for {serviceName} using your Care Identity account.
      </p>
      ...
      <ul>
        ...
        <li>
          use another authentication method – contact your local registration
          authority to enable this for your account
        </li>
      </ul>
